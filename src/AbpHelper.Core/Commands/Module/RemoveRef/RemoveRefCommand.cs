...
{
    public class RemoveRefCommand : CommandWithOption<RemoveRefCommandOption>
    {
        ...
        public RemoveRefCommand([NotNull] IServiceProvider serviceProvider) : base(serviceProvider, "removeref", "Remove ABP module according to the specified projects")
        {
            AddValidator(result =>
            {
        ...
        public override Task RunCommand(RemoveRefCommandOption option)
        {
        ...
        protected override IActivityBuilder ConfigureBuild(RemoveRefCommandOption option, IActivityBuilder activityBuilder)
        {
            var moduleNameToAppProjectNameMapping = typeof(ModuleRefCommandOption).GetProperties()
                            ...
                            branch.When(OutcomeNames.Iterate)
                                ...
                                .Then<RunCommandStep>(
                                    step => step.Command = new JavaScriptExpression<string>(
                                        $@"`cd{cdOption} ${{AspNetCoreDir}}/src/${{ProjectInfo.FullName}}.${{TargetAppProjectName}} && dotnet remove reference ${{{CommandConsts.OptionVariableName}.{nameof(RemoveRefCommandOption.SrcFolder)}}}\\${{{CommandConsts.OptionVariableName}.{nameof(RemoveRefCommandOption.ModuleName)}}}.${{TargetAppProjectName}}\\${{{CommandConsts.OptionVariableName}.{nameof(RemoveRefCommandOption.ModuleName)}}}.${{TargetAppProjectName}}.csproj`"
                                    ))
                                .Then(branch)
                    )
                ;
